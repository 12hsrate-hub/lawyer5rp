...
async def law_qa_test(
    ...
    payload = payload.model_copy(update={"server_code": effective_server_code, "model": ai_service.get_default_law_qa_model()})
    ...
    metrics_store.log_event(
        ...
        meta={
            ...
            "model": ai_service.get_default_law_qa_model(),
