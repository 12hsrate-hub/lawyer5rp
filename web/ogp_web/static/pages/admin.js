  ...
  aiPipelineHost.innerHTML = `
    ...
    <div class="admin-performance-grid">
      <article class="legal-status-card">
        ...
        <strong class="legal-status-card__value legal-status-card__value--small">${escapeHtml(String(quality?.wrong_fact_rate ?? "n/a"))}%</strong>
      ...
      <article class="legal-status-card">
        ...
        <strong class="legal-status-card__value legal-status-card__value--small">${escapeHtml(String(quality?.unclear_answer_rate ?? "n/a"))}%</strong>
      ...
      <article class="legal-status-card">
        ...
        <strong class="legal-status-card__value legal-status-card__value--small">${escapeHtml(String(quality?.validation_retry_rate ?? "n/a"))}%</strong>
