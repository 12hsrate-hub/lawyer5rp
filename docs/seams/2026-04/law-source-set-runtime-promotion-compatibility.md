...
- Remaining risks:
  ...
  - canonical law-document versions now support manual bounded fetch, but there is still no parse stage, no rich fetch scheduler, and no server-effective runtime promotion
