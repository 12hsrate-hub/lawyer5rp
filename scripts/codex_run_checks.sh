...
if command -v python >/dev/null 2>&1; then
  run_step "python syntax checks" python -m py_compile tests/test_point3_contract.py tests/test_mode_router.py tests/test_validator_retry.py
  run_step "pytest point3" python -m pytest -q tests/test_point3_contract.py tests/test_mode_router.py tests/test_validator_retry.py
else
