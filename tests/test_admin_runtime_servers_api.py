...
class AdminRuntimeServersApiTests(unittest.TestCase):
    ...
    def test_runtime_server_health_treats_law_set_as_observational_shell_check(self):
        ...
        self.assertEqual(payload["checks"]["config_resolution"]["path_stage"], "bootstrap")
    ...
    def test_runtime_server_workspace_endpoint_returns_server_centric_summary(self):
        ...
        self.assertEqual(payload["health"]["checks"]["config_resolution"]["path_role"], "transitional_runtime_path")
        self.assertEqual(payload["health"]["checks"]["config_resolution"]["path_stage"], "bootstrap")
        ...
        self.assertEqual(payload["overview"]["laws"]["runtime_config_debt"]["path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["runtime_resolution_policy"]["status"], "transitional_bootstrap")
        self.assertEqual(payload["overview"]["laws"]["runtime_resolution_policy"]["path_stage"], "bootstrap")
        ...
        self.assertEqual(payload["overview"]["laws"]["runtime_shell_debt"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_convergence"]["status"], "blocked")
        self.assertEqual(payload["overview"]["laws"]["runtime_convergence"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["cutover_readiness"]["status"], "needs_activation_alignment")
        self.assertEqual(payload["overview"]["laws"]["cutover_readiness"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_cutover_mode"]["status"], "compatibility_mode")
        self.assertEqual(payload["overview"]["laws"]["runtime_cutover_mode"]["config_path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["runtime_bridge_policy"]["status"], "keep_compatibility")
        self.assertEqual(payload["overview"]["laws"]["runtime_bridge_policy"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_bridge_policy"]["config_path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["runtime_operating_mode"]["status"], "compatibility_runtime")
        self.assertEqual(payload["overview"]["laws"]["runtime_operating_mode"]["config_path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["runtime_policy_violations"]["status"], "clear")
        self.assertEqual(payload["overview"]["laws"]["runtime_policy_violations"]["shell_stage"], "active_without_projection")
        ...
        self.assertEqual(payload["overview"]["laws"]["runtime_policy_enforcement"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["policy_breach_summary"]["status"], "clear")
        self.assertEqual(payload["overview"]["laws"]["policy_breach_summary"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_risk_register"]["status"], "high")
        self.assertEqual(payload["overview"]["laws"]["runtime_risk_register"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_governance_contract"]["status"], "compatibility_contract")
        self.assertEqual(payload["overview"]["laws"]["runtime_governance_contract"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["legacy_path_allowance"]["status"], "compatibility_allowed")
        self.assertEqual(payload["overview"]["laws"]["legacy_path_allowance"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["legacy_path_allowance"]["config_path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["compatibility_exit_scorecard"]["status"], "not_ready")
        self.assertEqual(payload["overview"]["laws"]["compatibility_exit_scorecard"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_breach_categories"]["status"], "attention")
        self.assertEqual(payload["overview"]["laws"]["runtime_breach_categories"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["legacy_path_controls"]["status"], "compatibility_controls")
        self.assertEqual(payload["overview"]["laws"]["legacy_path_controls"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["legacy_path_controls"]["config_path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["projection_runtime_gate"]["status"], "guarded")
        self.assertEqual(payload["overview"]["laws"]["projection_runtime_gate"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["compatibility_shrink_decision"]["status"], "hold_compatibility")
        self.assertEqual(payload["overview"]["laws"]["compatibility_shrink_decision"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["runtime_exception_register"]["status"], "open")
        self.assertEqual(payload["overview"]["laws"]["runtime_exception_register"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["compatibility_path_matrix"]["status"], "transition_matrix")
        self.assertEqual(payload["overview"]["laws"]["compatibility_path_matrix"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["compatibility_path_matrix"]["config_path_stage"], "bootstrap")
        self.assertEqual(payload["overview"]["laws"]["next_shrink_step"]["status"], "hold")
        self.assertEqual(payload["overview"]["laws"]["next_shrink_step"]["shell_stage"], "active_without_projection")
        self.assertEqual(payload["overview"]["laws"]["shrink_sequence"]["status"], "queued")
        self.assertEqual(payload["overview"]["laws"]["shrink_sequence"]["shell_stage"], "active_without_projection")
    ...
    def test_runtime_server_laws_workspace_endpoints_return_summary_effective_and_diff(self):
        ...
        self.assertTrue(summary.json()["runtime_version_parity"]["shell_artifact_present"])
        ...
        self.assertNotIn("projected_law_set=", summary.json()["runtime_version_parity"]["drift_summary"])
        self.assertEqual(summary.json()["runtime_version_parity"]["drift_summary"], "active_version=91")
        ...
        self.assertFalse(summary.json()["projection_bridge_lifecycle"]["shell_artifact_present"])
        ...
        self.assertEqual(summary.json()["runtime_shell_debt"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["runtime_convergence"]["status"], "blocked")
        self.assertEqual(summary.json()["runtime_convergence"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["cutover_readiness"]["status"], "needs_activation_alignment")
        self.assertEqual(summary.json()["cutover_readiness"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["runtime_bridge_policy"]["status"], "keep_compatibility")
        self.assertEqual(summary.json()["runtime_bridge_policy"]["shell_stage"], "active_without_projection")
        ...
        self.assertEqual(summary.json()["runtime_policy_violations"]["shell_stage"], "active_without_projection")
        ...
        self.assertEqual(summary.json()["runtime_policy_enforcement"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["policy_breach_summary"]["status"], "clear")
        self.assertEqual(summary.json()["policy_breach_summary"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["runtime_risk_register"]["status"], "high")
        self.assertEqual(summary.json()["runtime_risk_register"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["runtime_governance_contract"]["status"], "compatibility_contract")
        self.assertEqual(summary.json()["runtime_governance_contract"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["legacy_path_allowance"]["status"], "compatibility_allowed")
        self.assertEqual(summary.json()["legacy_path_allowance"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["compatibility_exit_scorecard"]["status"], "not_ready")
        self.assertEqual(summary.json()["compatibility_exit_scorecard"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["runtime_breach_categories"]["status"], "attention")
        self.assertEqual(summary.json()["runtime_breach_categories"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["legacy_path_controls"]["status"], "compatibility_controls")
        self.assertEqual(summary.json()["legacy_path_controls"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["projection_runtime_gate"]["status"], "guarded")
        self.assertEqual(summary.json()["projection_runtime_gate"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["compatibility_shrink_decision"]["status"], "hold_compatibility")
        self.assertEqual(summary.json()["compatibility_shrink_decision"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["runtime_exception_register"]["status"], "open")
        self.assertEqual(summary.json()["runtime_exception_register"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["compatibility_path_matrix"]["status"], "transition_matrix")
        self.assertEqual(summary.json()["compatibility_path_matrix"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["next_shrink_step"]["status"], "hold")
        self.assertEqual(summary.json()["next_shrink_step"]["shell_stage"], "active_without_projection")
        self.assertEqual(summary.json()["shrink_sequence"]["status"], "queued")
        self.assertEqual(summary.json()["shrink_sequence"]["shell_stage"], "active_without_projection")
        ...
        self.assertTrue(diff.json()["runtime_version_parity"]["shell_artifact_present"])
        ...
        self.assertNotIn("projected_law_set=", diff.json()["runtime_version_parity"]["drift_summary"])
        self.assertEqual(diff.json()["runtime_version_parity"]["drift_summary"], "active_version=91")
        ...
        self.assertFalse(diff.json()["projection_bridge_lifecycle"]["shell_artifact_present"])
        ...
        self.assertEqual(diff.json()["runtime_shell_debt"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["runtime_convergence"]["status"], "blocked")
        self.assertEqual(diff.json()["runtime_convergence"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["cutover_readiness"]["status"], "needs_activation_alignment")
        self.assertEqual(diff.json()["cutover_readiness"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["runtime_bridge_policy"]["status"], "keep_compatibility")
        self.assertEqual(diff.json()["runtime_bridge_policy"]["shell_stage"], "active_without_projection")
        ...
        self.assertEqual(diff.json()["runtime_policy_violations"]["shell_stage"], "active_without_projection")
        ...
        self.assertEqual(diff.json()["runtime_policy_enforcement"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["policy_breach_summary"]["status"], "clear")
        self.assertEqual(diff.json()["policy_breach_summary"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["runtime_risk_register"]["status"], "high")
        self.assertEqual(diff.json()["runtime_risk_register"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["runtime_governance_contract"]["status"], "compatibility_contract")
        self.assertEqual(diff.json()["runtime_governance_contract"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["legacy_path_allowance"]["status"], "compatibility_allowed")
        self.assertEqual(diff.json()["legacy_path_allowance"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["compatibility_exit_scorecard"]["status"], "not_ready")
        self.assertEqual(diff.json()["compatibility_exit_scorecard"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["runtime_breach_categories"]["status"], "attention")
        self.assertEqual(diff.json()["runtime_breach_categories"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["legacy_path_controls"]["status"], "compatibility_controls")
        self.assertEqual(diff.json()["legacy_path_controls"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["projection_runtime_gate"]["status"], "guarded")
        self.assertEqual(diff.json()["projection_runtime_gate"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["compatibility_shrink_decision"]["status"], "hold_compatibility")
        self.assertEqual(diff.json()["compatibility_shrink_decision"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["runtime_exception_register"]["status"], "open")
        self.assertEqual(diff.json()["runtime_exception_register"]["shell_stage"], "active_without_projection")
        self.assertEqual(diff.json()["compatibility_path_matrix"]["status"], "transition_matrix")
        self.assertEqual(diff.json()["compatibility_path_matrix"]["shell_stage"], "active_without_projection")
    ...
    def test_second_server_published_pack_health_endpoint_reports_release_candidate_state(self):
        ...
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_config_posture"]["path_role"], "declared_runtime_path")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_config_posture"]["path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_config_debt"]["status"], "low")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_config_debt"]["path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_resolution_policy"]["status"], "declared_runtime")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_resolution_policy"]["path_role"], "declared_runtime_path")
        ...
        self.assertTrue(workspace.json()["overview"]["laws"]["projection_bridge_lifecycle"]["shell_artifact_present"])
        ...
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_shell_debt"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_convergence"]["status"], "converged")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_convergence"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["cutover_readiness"]["status"], "ready_for_cutover")
        self.assertEqual(workspace.json()["overview"]["laws"]["cutover_readiness"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_cutover_mode"]["status"], "projection_preferred")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_cutover_mode"]["config_path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_bridge_policy"]["status"], "prefer_projection_runtime")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_bridge_policy"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_bridge_policy"]["config_path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_operating_mode"]["status"], "projection_runtime")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_operating_mode"]["config_path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_policy_violations"]["status"], "clear")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_policy_violations"]["shell_stage"], "activated")
        ...
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_policy_enforcement"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["policy_breach_summary"]["status"], "clear")
        self.assertEqual(workspace.json()["overview"]["laws"]["policy_breach_summary"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_risk_register"]["status"], "low")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_risk_register"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_governance_contract"]["status"], "projection_contract")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_governance_contract"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["legacy_path_allowance"]["status"], "denied")
        self.assertEqual(workspace.json()["overview"]["laws"]["legacy_path_allowance"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["legacy_path_allowance"]["config_path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_exit_scorecard"]["status"], "ready_to_exit")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_exit_scorecard"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_breach_categories"]["status"], "clear")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_breach_categories"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["legacy_path_controls"]["status"], "projection_controls")
        self.assertEqual(workspace.json()["overview"]["laws"]["legacy_path_controls"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["legacy_path_controls"]["config_path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["projection_runtime_gate"]["status"], "open")
        self.assertEqual(workspace.json()["overview"]["laws"]["projection_runtime_gate"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_shrink_decision"]["status"], "shrink_now")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_shrink_decision"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_exception_register"]["status"], "clear")
        self.assertEqual(workspace.json()["overview"]["laws"]["runtime_exception_register"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_path_matrix"]["status"], "projection_matrix")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_path_matrix"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["compatibility_path_matrix"]["config_path_stage"], "published")
        self.assertEqual(workspace.json()["overview"]["laws"]["next_shrink_step"]["status"], "observe")
        self.assertEqual(workspace.json()["overview"]["laws"]["next_shrink_step"]["shell_stage"], "activated")
        self.assertEqual(workspace.json()["overview"]["laws"]["shrink_sequence"]["status"], "complete")
        self.assertEqual(workspace.json()["overview"]["laws"]["shrink_sequence"]["shell_stage"], "activated")
        ...
        self.assertEqual(payload["onboarding"]["next_required_state"], "production-ready")
